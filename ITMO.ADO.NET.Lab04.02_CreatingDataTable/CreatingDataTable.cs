...
namespace ITMO.ADO.NET.Lab04_CreatingDataTable
{
    public partial class CreatingDataTable : Form
    {
        ...
        private void FillChildTable_button_Click(object sender, EventArgs e)
        {
            FillChildTable_dataGridView.DataSource = bindingSource2;
        }

        private void FillParentTable_button_Click(object sender, EventArgs e)
        {
            FillParentTable_dataGridView.DataSource = bindingSource1;
        }
